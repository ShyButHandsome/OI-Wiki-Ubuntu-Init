...
changeSourceList() {
  ...
  echo "Your default sources list have backuped."
  echo "Now I am going to change your source list to tsinghua's source list:"
...
installResource() {
  ...
  sudo apt install build-essential vim ddd gdb fpc emacs gedit -y
